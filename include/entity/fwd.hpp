#ifndef ENTITY_FWD_HPP
#define ENTITY_FWD_HPP
...
////////////////////////////////////////////////////////////////////////////////
    ...
    namespace detail { struct concept_tag {}; }
    
    template <class T>
    using is_concept = typename 
        elib::aux::is_convertible< T, detail::concept_tag >::type;
